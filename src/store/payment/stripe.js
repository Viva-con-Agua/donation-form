    ...
    actions: {
        payment_intent_create({state, rootState}) {
            ...
            return new Promise((resolve, reject) => {
                api.call.post('/payments/payment/stripe/paymentintent', data)
        ...
        payment_intent_finish({rootState,state}) {
            ...
            return new Promise((resolve, reject) => {
                api.call.put('/payments/payment/stripe/paymentintent', data)
        ...
        setup_intent_create({state, rootState}) {
            ...
            return new Promise((resolve, reject) => {
                api.call.post('/payments/payment/stripe/setupintent', data)
                    .then((response) => {resolve(response)})
                    .catch((error) => {
                        reject(error)
                    })
        ...
        setup_intent_finish({rootState,state}) {
            ...
            return new Promise((resolve, reject) => {
                api.call.put('/payments/payment/stripe/setupintent', data)
                    .then((response) => {console.log(response), resolve()})
                    .catch((error) => {
                        reject(error)
                    })
