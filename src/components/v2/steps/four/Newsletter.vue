        ...
        <div class="button-wrapper">
            <div class="container">
                ...
                <div class="block">
                    ...
                    <button v-if="flow" class="vca-button" @click.prevent="submit">
                        {{ $t('next.newsletter.button') }}
                        <div class="btnBg"></div>
                    </button>

                    <div class="vca-column" v-else>
                        <button class="vca-button nl-button" disabled @click.prevent="submit">
                            {{ $t('next.newsletter.button') }}
                        </button>
                        <div class="primary-dark bold tenseconds-success vca-border text-center">
