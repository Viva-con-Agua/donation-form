...
export default {
        ...
        if (paypal !== undefined) {
            ...
            paypalScript.setAttribute(
                ...
                "https://www.paypal.com/sdk/js?client-id=" +
                    this.company.paypal_client_id +
                    "&vault=true&disable-funding=credit,card,sepa,giropay,sofort&currency=EUR&intent=subscription"
            );
    ...
    methods: {
        success(e) {
            ...
            this.$store
                .dispatch("payment/paypal/subscription_finish")
                .then(() => {
                    this.$emit("success");
                })
    ...
    created() {
        this.$store
            .dispatch("payment/paypal/subscription_create")
            .then(() => {
                this.show = true;
            })
            .catch((error) => {
